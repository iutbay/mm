            ...
            <div class="details-widget-content panel-body">
                ...
                <p class="buttons">
                    ...
                    <template v-if="file.type!='dir'">
                        <a v-if="mmc.downloadLink(file)" v-bind:href="mmc.downloadLink(file)" class="btn btn-primary btn-sm" role="button"><i class="fa fa-download" aria-hidden="true"></i> Download</a>
